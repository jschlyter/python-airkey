...
class JsonNode(object):
    ...
    def __init__(self, _float=None, node_type=None, number=None, binary=None, object=None, boolean=None, value_node=None, container_node=None, missing_node=None, pojo=None, integral_number=None, floating_point_number=None, short=None, _int=None, long=None, double=None, big_decimal=None, big_integer=None, textual=None, array=None, null=None):  # noqa: E501
