...
from airkey_client.models.person_paging_list import PersonPagingList  # noqa: E501
...
class TestPersonPagingList(unittest.TestCase):
    ...
    def testPersonPagingList(self):
        ...
        # model = airkey_client.models.person_paging_list.PersonPagingList()  # noqa: E501
        pass
